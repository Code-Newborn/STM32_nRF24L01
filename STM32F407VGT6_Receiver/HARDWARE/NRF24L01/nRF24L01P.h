...
typedef enum { nRF_DATA_PIPE_0 = 0, nRF_DATA_PIPE_1 = 1, nRF_DATA_PIPE_2 = 2, nRF_DATA_PIPE_3 = 3, nRF_DATA_PIPE_4 = 4, nRF_DATA_PIPE_5 = 5 } nRF_DATA_PIPE;
...
typedef enum { nRF_DATA_RATE_250KBPS = 1, nRF_DATA_RATE_1MBPS = 0, nRF_DATA_RATE_2MBPS = 2 } nRF_DATA_RATE;

typedef enum { nRF_TX_PWR_M18dBm = 0, nRF_TX_PWR_M12dBm = 1, nRF_TX_PWR_M6dBm = 2, nRF_TX_PWR_0dBm = 3 } nRF_TX_PWR;

typedef enum { nRF_ADDR_WIDTH_3 = 1, nRF_ADDR_WIDTH_4 = 2, nRF_ADDR_WIDTH_5 = 3 } nRF_ADDR_WIDTH;

typedef enum { nRF_CRC_WIDTH_BYTE = 0, nRF_CRC_WIDTH_HALFWORD = 1 } nRF_CRC_WIDTH;

typedef enum { nRF_STATE_TX = 0, nRF_STATE_RX = 1 } nRF_TXRX_STATE;

typedef enum { nRF_DISABLE = 0, nRF_ENABLE = 1 } nRF_STATE;
